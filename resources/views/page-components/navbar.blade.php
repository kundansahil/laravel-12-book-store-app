            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="{{ route('guest') }}" class="nav-item nav-link">Books</a>
                        <a href="{{ route('guest') }}" class="nav-item nav-link">Book Detail</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">More</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="{{ route('guest') }}" class="dropdown-item">My Cart</a>
                                <a href="{{ route('guest') }}" class="dropdown-item">Checkout</a>
                            </div>
                        </div>
                        <a href="{{ route('guest') }}" class="nav-item nav-link">Contact</a>
                    </div>
